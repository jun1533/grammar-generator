...
big = st.selectbox("② 대단원 선택", list(grammar_data[교재명].keys()))
middle = st.selectbox("③ 중단원 선택", list(grammar_data[교재명][대단원].keys()))
small = st.selectbox("④ 소단원 선택", grammar_data[교재명][대단원][중단원])
